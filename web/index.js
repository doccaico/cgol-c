...
var ASM_CONSTS = {
  88606: () => { if (document.fullscreenElement) return 1; },  
 88652: () => { return Module.canvas.width; },  
 88684: () => { return parseInt(Module.canvas.style.width); },  
 88732: () => { document.exitFullscreen(); },  
 88759: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88831: () => { if (document.fullscreenElement) return 1; },  
 88877: () => { return Module.canvas.width; },  
 88909: () => { return screen.width; },  
 88934: () => { document.exitFullscreen(); },  
 88961: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89155: () => { return window.innerWidth; },  
 89181: () => { return window.innerHeight; },  
 89208: () => { if (document.fullscreenElement) return 1; },  
 89254: () => { return Module.canvas.width; },  
 89286: () => { return parseInt(Module.canvas.style.width); },  
 89334: () => { if (document.fullscreenElement) return 1; },  
 89380: () => { return Module.canvas.width; },  
 89412: () => { return screen.width; },  
 89437: () => { return window.innerWidth; },  
 89463: () => { return window.innerHeight; },  
 89490: () => { if (document.fullscreenElement) return 1; },  
 89536: () => { return Module.canvas.width; },  
 89568: () => { return screen.width; },  
 89593: () => { document.exitFullscreen(); },  
 89620: () => { if (document.fullscreenElement) return 1; },  
 89666: () => { return Module.canvas.width; },  
 89698: () => { return parseInt(Module.canvas.style.width); },  
 89746: () => { document.exitFullscreen(); },  
 89773: ($0) => { Module.canvas.style.opacity = $0; },  
 89811: () => { return screen.width; },  
 89836: () => { return screen.height; },  
 89862: () => { return window.screenX; },  
 89889: () => { return window.screenY; },  
 89916: () => { return window.devicePixelRatio; },  
 89952: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90005: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90056: () => { Module.canvas.style.cursor = 'none'; },  
 90093: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90349: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90400: () => { if (document.pointerLockElement) return 1; },  
 90447: () => { if (document.fullscreenElement) return 1; },  
 90493: () => { return window.innerWidth; },  
 90519: () => { return window.innerHeight; }
};
